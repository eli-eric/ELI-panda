...
export const SystemMovingEditForm = ({
    ...
    const childParentUid =
        childSystem?.parentPath && childSystem?.parentPath[childSystem?.parentPath?.length - 1].uid
    ...
    return (
        <div className="space-y-4">
            <Form formMethods={formMethods} onSubmit={updateSystem} enableLeaveWarning={false}>
                <SheetFormButtons
