    ...
    <Fragment>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
        <div className="pt-4 grid grid-cols-12">
          <InputWithError {...fields.name} className="pb-1 col-span-6 pr-1" />
        ...
        <div className="pt-4 grid grid-cols-12 ">
          ...
          <InputWithError {...fields.orderNumber} className="pb-1 col-span-3 pr-1" />
          <InputWithError {...fields.requestNumber} className="pb-1 col-span-3 pr-1" />
          <InputWithError {...fields.contractNumber} className="pb-1 col-span-3 pr-1" />
        </div>
        <div className="pt-4 grid grid-cols-12 ">
