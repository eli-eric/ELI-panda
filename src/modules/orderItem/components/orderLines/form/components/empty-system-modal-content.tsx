...
export function EmptySystemModalContent({ onSelect, onClose }: EmptySystemModalContentProps) {
    const [selectedSystem, setSelectedSystem] = useState<SystemDetail | undefined>(undefined)
    ...
    return (
        <div className="flex min-h-0 flex-col gap-4">
            ...
            <div className="relative z-20 flex shrink-0 justify-end gap-2 border-t bg-background pt-4">
                ...
                <Button type="button" disabled={!selectedSystem} onClick={handleConfirm}>
