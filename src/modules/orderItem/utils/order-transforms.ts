...
import type { OrderDetailFormType, OrderLineFormType, ServiceLine } from '../types/form'
 ...
 */
export const addUuidsToOrderData = (orderDetail: OrderDetailFormType): OrderDetailFormType => {
    return {
        ...orderDetail,
 ...
 */
export const prepareOrderForSubmit = (data: OrderDetailFormType): OrderDetailFormType => {
    return {
        ...data,
...
export const hasEmptyLines = (data: OrderDetailFormType): boolean => {
    ...
    const hasNoServiceLines = !data?.serviceLines || data.serviceLines.length === 0
