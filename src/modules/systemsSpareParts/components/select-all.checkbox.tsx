...
export function SelectAllCheckbox({ table, setSelectedUids }: IndeterminateCheckboxProps) {
    ...
    const handleToggleSelectAllTopLevel = () => {
        ...
        const topLevelSystemsUids = topLevelRowIds.map(id => table.getRow(id).original.uid)
