...
export const showSuccessToast = (
    ...
    toast.success(
        intl.formatMessage({ id: messageId }, values ? createMessageValues(values) : undefined),
    )
}
...
export const validateSystemForm = (
    ...
    if (!systemForm.name) {
        showErrorToast(intl, message.systemsPage.systemDetail.createModal.onValidationError)
        return false
    }
    return true
}
