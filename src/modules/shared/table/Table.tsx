import type { Column, ColumnDef, ExpandedState, SortingState, Table as ReactTable, Table } from '@tanstack/react-table'
...
const PandaTable = memo(
  forwardRef<ReactTable<any> | undefined, Props<any>>(function Table<T extends object>(
