  ...
  return (
    <th
      ...
      className={classNames(
        'whitespace-nowrap border-r border-b border-gray-400 bg-opacity-75 py-2 pl-3 pr-3 text-left text-xs font-semibold text-gray-900 dark:text-gray-200 backdrop-blur backdrop-filter sm:pl-6 sm:pr-5',
