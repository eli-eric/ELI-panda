...
import { CategoryName } from '../table/cells/CategoryNameCell'
import { DescriptionCell } from '../table/cells/DescriptionCell'
import { ManufacturerUrl } from '../table/cells/ManufacturerUrlCell'
...
export const useCatalogueItemSelectColumns = ({
  tableId,
  hideButtons,
  catalogueItems,
  setCategoryFilter,
    ...
    const columns: ColumnDef<CatalogueItem, any>[] = [
      {
        ...
        cell: ({ row: { original } }) => {
          ...
          return (
            <Checkbox
              checked={isSelected}
              onCheckedChange={() => onItemToggle(original)}
