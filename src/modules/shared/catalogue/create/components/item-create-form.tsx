...
import { createItemSchema, type ItemCreateFormData } from './item-create-form.schema'
...
export const ItemCreateForm = ({ onItemCreated, onClose }: ItemCreateFormProps) => {
    ...
    const [catalogueNumberToValidate, setCatalogueNumberToValidate] = useState<string | null>(null)
    ...
    }, [isUnique, isChecking, catalogueNumberToValidate, setError, clearErrors, fm])
    ...
    const isSubmitDisabled = useMemo(() => {
        ...
        return catalogueNumberToValidate !== currentValue || isUnique === false
    }, [loading, isChecking, catalogueNumber, catalogueNumberToValidate, isUnique])
        ...
        <FormProvider {...formMethods}>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <Grid>
                    ...
                    <Col lg={12}>
                        <Input {...fields.catalogueNumber} onBlur={handleCatalogueNumberBlur} />
                        {isChecking && (
