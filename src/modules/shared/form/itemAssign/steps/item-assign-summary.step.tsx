...
export const ItemAssignSummaryStep: FC = () => {
    ...
    const { submitWizard, isPending, goBack, formData, updateFormData, selectedSystem } =
        useMoveWizardSubmit()
            ...
            <Card title="Summary">
                <div className={cn('grid grid-cols-2')}>
                    <ul className="grid grid-cols-1">
                        ...
                        <SummaryListParam name="Location" value={selectedSystem?.location?.name} />
                    </ul>
                    <ul className="grid grid-cols-1">
                        <h3 className="font-bold underline text-gray-600 dark:text-gray-200">
                        ...
                        />
                        <SummaryListParam name="Eun" value={selectedSystem?.physicalItem?.eun} />
                        <SummaryListParam
                        ...
                        <SummaryListParam
                            name="Part Number"
                            value={selectedSystem?.physicalItem?.catalogueItem?.catalogueNumber}
                        />
                    </ul>
                </div>
            </Card>
