...
import type { DefaultValues, FieldValues, Path, UseFormReset } from 'react-hook-form'
...
export const FormWizard = <T extends Record<string, any>>({
    ...
    const currentStepIndexInVisible = visibleSteps.findIndex(step => step.id === currentStep?.id)
        ...
        <div>
            ...
            <FormProvider {...methods}>
                <form onSubmit={handleSubmit(data => onSubmit(data, reset))}>
                    <FormStep fields={currentStep.fields} component={currentStep.component} />
