...
export const SummaryStep: FC = () => {
    ...
    return (
        <Fragment>
            <Card title="Summary">
                <div className={cn(oldItemParentSystem ? 'grid grid-cols-3' : 'grid grid-cols-2')}>
                    <ul className="grid grid-cols-1">
                        ...
                        />
                        <SummaryListParam name="Location" value={formData?.location?.name} />
                    </ul>
                    <ul className="grid grid-cols-1">
                    ...
                    {oldItemParentSystem && (
                        <ul className="grid grid-cols-1">
                            ...
                            />
                            <SummaryListParam name="Code" value={oldItemParentSystem?.systemCode} />
                            <SummaryListParam name="Zone" value={oldItemParentSystem?.zone?.name} />
                            <SummaryListParam
                                name="Location"
