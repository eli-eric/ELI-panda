...
function IndeterminateCheckbox({
    ...
    const { removeDestinationSystem, removeMovingSystem, setDestinationSystem, addMovingSystem } =
        useSystemsMoveStore()
...
export const useMoveSystemsColumns = ({ tableId }: SystemsColumnsProps) => {
    ...
    const { movingSystemsTableId, destinationSystemsTableId } = useSystemsMoveStore()
                ...
                cell: props => (
                    <div className="flex justify-between w-full">
                        <SystemNameCell
                            ...
                            tableId={tableId}
                        />
                        {props.row.getIsSelected() && tableId === destinationSystemsTableId && (
                            <SubmitMoveButton />
                        )}
                    </div>
                ),
