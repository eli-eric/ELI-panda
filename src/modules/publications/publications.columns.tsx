    ...
    const columns = useMemo(
        (): ColumnDef<Publication, any>[] => [
            ...
            },
            {
                id: 'mediaType',
                header: 'Media Type',
                accessorFn: row => row.mediaTypeCb?.name || MEDIA_TYPE_MAP[row.mediaType || ''],
                size: 200,
            },
            {
                id: 'eliPublication',
            ...
            },
            {
                ...
                size: 300,
                cell: ({ getValue }) => <ShortCell value={getValue()} numberOfChars={30} />,
            },
            {
                id: 'allAuthorsCount',
            ...
            },
            {
                ...
                accessorFn: row =>
                    row.eliResearchers?.map(er => `${er.firstName} ${er.lastName}`).join('; '),
                size: 300,
            },
            {
                id: 'eliAuthorsCount',
            ...
            },
            {
                ...
                size: 400,
                cell: ({ getValue }) => <ShortCell value={getValue()} numberOfChars={50} />,
            },
            {
                id: 'volume',
                header: 'Volume',
...

            {
                ...
                size: 400,
                cell: ({ getValue }) => <ShortCell value={getValue()} numberOfChars={40} />,
            },
            {
                id: 'impactFactor',
            ...
            },
            {
                ...
                size: 400,
                cell: ({ getValue }) => <ShortCell value={getValue()} numberOfChars={100} />,
            },
            {
                id: 'keywords',
                header: 'Keywords',
            ...
            },
            {
                ...
                cell: ({ getValue }) => <ShortCell value={getValue()} numberOfChars={35} />,
            },
            {
                id: 'issn',
                header: 'ISSN',
