...
/**
 * Applies a member-operation response to the caches: merges the returned
 * TeamDetail into the cached detail (never overwrites — a partial payload must
 * not drop name/code/description) and invalidates detail + list (memberCount).
