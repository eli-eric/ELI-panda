...
describe('MoveButtons', () => {
    it('disables up button when index is 0', () => {
        render(
            <MoveButtons index={0} lenght={3} moveUp={jest.fn()} moveDown={jest.fn()} />,
        )
    ...
    it('disables down button when index is last', () => {
        render(
            <MoveButtons index={2} lenght={3} moveUp={jest.fn()} moveDown={jest.fn()} />,
        )
        const [up, down] = screen.getAllByRole('button')
    ...
    it('disables both buttons when single item (index 0 of length 1)', () => {
        render(
            <MoveButtons index={0} lenght={1} moveUp={jest.fn()} moveDown={jest.fn()} />,
        )
        const [up, down] = screen.getAllByRole('button')
        expect(up).toBeDisabled()
        expect(down).toBeDisabled()
    ...
    it('calls moveUp with index on up click', () => {
        ...
        render(
            <MoveButtons index={1} lenght={3} moveUp={moveUp} moveDown={jest.fn()} />,
        )
    ...
    it('calls moveDown with index on down click', () => {
        ...
        render(
            <MoveButtons index={1} lenght={3} moveUp={jest.fn()} moveDown={moveDown} />,
        )
