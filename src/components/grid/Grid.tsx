...
import type { ColSizeProp, HorizontalSpacing, VerticalSpacing } from './ColSizes'
import {
    COL_SIZES,
...
export const Grid: React.FC<GridPropsT> = ({
    ...
    const vSpacingClass = VERTICAL_SPACING_CLASSES[verticalSpacing] || VERTICAL_SPACING_CLASSES[4]
    const hSpacingClass =
        HORIZONTAL_SPACING_CLASSES[horizontalSpacing] || HORIZONTAL_SPACING_CLASSES[2]
