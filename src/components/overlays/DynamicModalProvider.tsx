...
import { type ModalInstance, useDynamicModalStore } from '@/store/useDynamicModalStore'
        ...
        <Dialog open={true} onOpenChange={handleOpenChange}>
            <DialogPortal>
                ...
                <DialogContent
                    style={{ zIndex: contentZIndex }}
                    size={modal.props?.size || 'l'}
                    aria-describedby={modal.props?.description ? undefined : 'modal-content'}
                >
    ...
    return (
        <>
            {modalOrder.map(modalId => {
                ...
                if (modal.type === 'sheet') {
                    return <ModalSheetRenderer key={modalId} modal={modal} onClose={handleClose} />
                }

                return <ModalDialogRenderer key={modalId} modal={modal} onClose={handleClose} />
            })}
        </>
    )
}
