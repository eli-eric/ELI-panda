...
export const Heading = ({ text, children }: HeadingProps) => (
  <div className="mb-4 border-b border-gray-200 bg-white dark:bg-gray-900 px-2 py-2 sm:px-3">
    <div className="-ml-2 -mt-1 flex flex-wrap h-12 items-center justify-between sm:flex-nowrap">
      <div className="ml-2 mt-1">
        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-200">{text}</h3>
      </div>
