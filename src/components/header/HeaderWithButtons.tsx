...
export const HeaderWithButtons = ({
    ...
    const disabledSubmit = disableSubmit || loading || !disabledEdit || isFormInvalid
    const disabledSubmitAndExit = disableSubmitAndExit || loading || !disabledEdit || isFormInvalid
