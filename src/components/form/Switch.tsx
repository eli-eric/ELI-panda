...
export const Toggle = ({ enabled, onChange, className }: Props) => (
    <ShadcnSwitch checked={enabled} onCheckedChange={onChange} className={className} />
)
...
export const Switch = ({ name, defaultValue = true, className, label, onChange }: SwitchProps) => {
