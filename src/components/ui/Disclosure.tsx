...
export const Disclosure = ({
  ...
  const defaultButtonClasses = transparentButton
    ...
    : ' hover:text-orange-600 dark:hover:bg-slate-600 text-sm flex items-center justify-between w-full py-[2px] px-4 shadow-sm text-gray-500 bg-background hover:bg-gray-100'
