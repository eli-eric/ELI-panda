...
const PROTECTED_PATHS = [PATH.DASHBOARD, PATH.CATALOGUE, PATH.SYSTEMS, PATH.SYSTEMS_OVERVIEW, PATH.REPORTS, PATH.ORDERS]
...
const PATH_ROLES_CONFIG: Record<PATH, ROLE[]> = {
  ...
  [PATH.ORDERS]: [ROLE.ORDERS_VIEW, ROLE.ORDERS_EDIT, ROLE.BASICS],
  [PATH.ORDER_DETAIL]: [ROLE.ORDERS_VIEW, ROLE.ORDERS_EDIT],
  [PATH.ORDER_EDIT]: [ROLE.ORDERS_VIEW, ROLE.ORDERS_EDIT],
  [PATH.ORDER_NEW]: [ROLE.ORDERS_VIEW, ROLE.ORDERS_EDIT],
  [PATH.ROOT]: []
}
