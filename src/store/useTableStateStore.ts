...
type TableState = {
    ...
    setSearchValue: (tableId: string, searchBarValue: SortingInstance['searchBarValue']) => void
...
const useTableStateStore = create<TableState>()(
    persist(
        set => {
            const updateInstance = (tableId: string, key: keyof SortingInstance, value: any) => {
                set(state => {
            ...
            return {
                ...
                setExpand: (tableId, expanded) => updateInstance(tableId, 'expanded', expanded),
