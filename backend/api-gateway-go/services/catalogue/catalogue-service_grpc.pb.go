...
func (c *catalogueServiceClient) GetCatalogueItemByID(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*CatalogueItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pandaMicroservices.CatalogueService/GetCatalogueItemByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CatalogueService_GetCatalogueItemByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pandaMicroservices.CatalogueService/GetCatalogueItemByID",
	}
...
var CatalogueService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pandaMicroservices.CatalogueService",
