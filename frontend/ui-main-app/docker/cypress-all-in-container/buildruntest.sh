...
yarn cypress run --browser chrome --tag "chrome" --env host=http://localhost:5001
yarn cypress run --browser edge --tag "edge" --env host=http://localhost:5001
yarn cypress run --browser firefox --tag "firefox" --env host=http://localhost:5001 &
