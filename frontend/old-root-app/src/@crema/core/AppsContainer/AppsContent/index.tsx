...
const AppsContentContainer: React.FC<AppsContentContainerProps> = styled(SimpleBarReact)(
...
const AppsContent: React.FC<AppsContentProps> = props => {
  return <AppsContentContainer {...props}>{props.children}</AppsContentContainer>
}
